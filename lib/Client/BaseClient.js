...
import { isResourceMissingSubject, resourceMayContainEncounter } from "../Resource/resourceUtils";
                    ...
                    case 0:
                        subject = function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!isResourceMissingSubject(r4Resource)) return [3 /*break*/, 2];
                        ...
                        _a = [__assign(__assign({}, fhirClientResource), subject)];
                        if (!!resourceMayContainEncounter(r4Resource)) return [3 /*break*/, 1];
                        _b = {};
                        return [3 /*break*/, 5];
                    case 1:
                        if (!("encounter" in fhirClientResource)) return [3 /*break*/, 2];
                        _c = {};
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.createContext(encounterId)];
                    case 3:
                        _c = _d.sent();
                        _d.label = 4;
                    case 4:
                        _b = _c;
                        _d.label = 5;
                    case 5: return [2 /*return*/, __assign.apply(void 0, _a.concat([(_b)]))];
                }
            });
        });
    };
    ...
    BaseClient.prototype.create = function (r4Resource, patientId, encounterId, additionalHeaders) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        transformedResource = Transformer.toFhirClientType(r4Resource);
