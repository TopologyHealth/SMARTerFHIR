 ...
 */
     ...
     */
    ClientFactory.prototype.createEMRClient = function (launchType, redirect_uri) {
        if (launchType === void 0) { launchType = LAUNCH.EMR; }
        return __awaiter(this, void 0, void 0, function () {
            var defaultFhirClient, emrType;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.createDefaultFhirClient(launchType, redirect_uri)];
                    case 1:
     ...
     */
    ClientFactory.prototype.createDefaultFhirClient = function (launchType, redirect_uri) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3: return [4 /*yield*/, this.buildStandaloneFhirClient(redirect_uri !== null && redirect_uri !== void 0 ? redirect_uri : window.location.href)];
    ...
    ClientFactory.prototype.buildStandaloneFhirClient = function (redirect_uri) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, getAccessToken(tokenEndpoint, code, clientId, redirect_uri)];
                    case 1:
 ...
 */
function getAccessToken(tokenEndpoint, code, clientId, redirect_uri) {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
