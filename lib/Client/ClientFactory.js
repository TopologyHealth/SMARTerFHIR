 ...
 */
    ...
    ClientFactory.prototype.buildStandaloneFhirClient = function () {
        return __awaiter(this, void 0, void 0, function () {
            var code, decodedJwt, clientId, _a, tokenEndpoint, r4Endpoint, redirectUri, tokenResponse, defaultFhirClient;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        ;
                        return [4 /*yield*/, getAccessToken(tokenEndpoint, code, clientId, redirectUri)];
                    case 1:
