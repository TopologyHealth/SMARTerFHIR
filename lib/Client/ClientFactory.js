...
var ClientFactory = /** @class */ (function () {
    function ClientFactory(clientID) {
    ...
    ClientFactory.prototype.createEMRClient = function () {
        return __awaiter(this, void 0, void 0, function () {
            var defaultFhirClient, emrType, _a, patientID;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, FHIR.oauth2.ready()];
                    case 1:
                        defaultFhirClient = _b.sent();
                        emrType = this.getEMRType(defaultFhirClient);
                        _a = emrType;
                        switch (_a) {
                            case EMR.EPIC: return [3 /*break*/, 2];
                            case EMR.CERNER: return [3 /*break*/, 4];
                            case EMR.SMART: return [3 /*break*/, 4];
                            case EMR.NONE: return [3 /*break*/, 4];
                        }
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, defaultFhirClient.patient.id];
                    case 3:
                        patientID = _b.sent();
                        console.log("patientID: ".concat(patientID));
                        return [2 /*return*/, new EpicClient(defaultFhirClient)];
                    case 4: return [2 /*return*/, new EpicClient(defaultFhirClient)];
                }
            });
        });
    };
