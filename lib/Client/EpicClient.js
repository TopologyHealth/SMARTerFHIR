...
var EpicClient = /** @class */ (function (_super) {
    ...
    EpicClient.prototype.create = function (resource) {
        return __awaiter(this, void 0, void 0, function () {
            var transformedResource, resultResource;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        transformedResource = Transformer.toFhirClientType(resource);
                        return [4 /*yield*/, this.fhirClientDefault.create(transformedResource, this.createHeaders)
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, Transformer.toR4FhirType(resultResource)];
                }
            });
        });
    };
