...
var EPIC_TOKEN_ENDPOINT = "https://fhir.epic.com/interconnect-fhir-oauth/oauth2/token";
var EPIC_R4_ENDPOINT = "https://fhir.epic.com/interconnect-fhir-oauth/api/FHIR/R4/";
/**
Represents the EpicClient class, extending the BaseClient.
*/
var EpicClient = /** @class */ (function (_super) {
    __extends(EpicClient, _super);
    /**
   ...
   */
    ...
    EpicClient.prototype.create = function (resource) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, _super.prototype.create.call(this, resource, this.createHeaders(this.epicCreateHeaders))];
            });
        });
    };
    return EpicClient;
