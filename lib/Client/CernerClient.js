...
var CernerClient = /** @class */ (function (_super) {
     ...
     */
    CernerClient.prototype.hydrateResource = function (fhirClientResource, r4Resource) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = [{}];
                        return [4 /*yield*/, _super.prototype.hydrateResource.call(this, fhirClientResource, r4Resource)];
                    case 1:
                        _b = [__assign.apply(void 0, _a.concat([(_d.sent())]))];
                        if (!("author" in r4Resource)) return [3 /*break*/, 2];
                        _c = {};
                        return [3 /*break*/, 4];
