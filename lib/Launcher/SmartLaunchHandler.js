...
var SmartLaunchHandler = /** @class */ (function () {
     ...
     */
    SmartLaunchHandler.prototype.authorizeEMR = function (launchType, emrType, redirectUriOverride) {
        if (launchType === void 0) { launchType = LAUNCH.EMR; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(launchType === LAUNCH.EMR)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.executeEMRLaunch()];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        if (launchType === LAUNCH.STANDALONE) {
                            return [2 /*return*/, this.executeStandaloneLaunch(emrType, redirectUriOverride)];
                        }
     ...
     */
    SmartLaunchHandler.prototype.executeStandaloneLaunch = function (emrType, redirectUriOverride) {
        if (!emrType)
        ...
        var standaloneUrl = this.generateStandaloneUrl(emrType, redirectUri);
        switch (emrType) {
            case EMR.EPIC:
            case EMR.CERNER:
            case EMR.SMART:
    ...
    SmartLaunchHandler.prototype.generateStandaloneUrl = function (emrType, redirectUri) {
        var _a = this.getEndpointsForEmr(emrType), r4Endpoint = _a.r4, authEndpoint = _a.auth;
   ...
   */
    SmartLaunchHandler.prototype.getEndpointsForEmr = function (emrType) {
        switch (emrType) {
            case EMR.EPIC:
     ...
     */
    SmartLaunchHandler.prototype.executeEMRLaunch = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
