        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1: return [4 /*yield*/, this.executeWebLaunch(launchType)];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 7];
                    case 1: return [4 /*yield*/, this.epicLaunch(originString, iss, launchType)];
                    case 2:
                        _c.sent();
                        return [3 /*break*/, 8];
                    case 3: return [4 /*yield*/, this.cernerLaunch(originString, iss, launchType)];
                    case 4:
                        _c.sent();
                        return [3 /*break*/, 8];
                    case 5: return [4 /*yield*/, this.smartHealthITLaunch(originString, iss, launchType)];
                    case 6:
                        _c.sent();
                        return [3 /*break*/, 8];
