    ...
    SmartLaunchHandler.prototype.cernerLaunch = function (clientId, redirect, iss) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, FHIR.oauth2.authorize({
                        clientId: clientId,
                        scope: __spreadArray(__spreadArray(["launch"], cernerString, true), ["online_access", "openid", "fhirUser"], false).join(" "),
                        iss: iss,
                        "redirect_uri": redirect_uri
                    })];
            });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(iss !== null && iss.includes(this.emrType))) return [3 /*break*/, 6];
                        _a = this.emrType;
                        switch (_a) {
