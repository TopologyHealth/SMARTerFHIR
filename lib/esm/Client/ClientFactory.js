...
export default class ClientFactory {
    ...
    */
     ...
     */
    createEMRClient(launchType = LAUNCH.EMR, fhirClient) {
        return __awaiter(this, void 0, void 0, function* () {
            if (launchType === LAUNCH.BACKEND) {
                if (!fhirClient)
                    throw new Error(`FhirClient must be passed as a param for Backend Authentication`);
            }
            const defaultFhirClient = fhirClient !== null && fhirClient !== void 0 ? fhirClient : yield this.createDefaultFhirClient(launchType);
