...
export default class BaseClient {
    ...
    hydrateResource(fhirClientResource, r4Resource, patientId, encounterId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Object.assign(Object.assign(Object.assign({}, fhirClientResource), subject), (!resourceMayContainEncounter(r4Resource)
                ? {}
                : "encounter" in fhirClientResource
                    ? {}
                    : yield this.createContext(encounterId)));
        });
    }
    /**
