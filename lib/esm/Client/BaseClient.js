...
export default class BaseClient {
     ...
     */
    createReferenceToEncounter(encounterIdParam) {
        return __awaiter(this, void 0, void 0, function* () {
            const encounterID = encounterIdParam == undefined ? yield this.getIDfromObject(this.fhirClientDefault.encounter) : encounterIdParam;
            return {
                reference: `Encounter/${encounterID}`,
    ...
    createEncounterReferenceArray(encounterIdParam) {
        return __awaiter(this, void 0, void 0, function* () {
            return [yield this.createReferenceToEncounter(encounterIdParam)];
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const encounter = () => __awaiter(this, void 0, void 0, function* () {
                if (isResourceMissingEncounter(r4Resource))
                    return yield this.createEncounterReference(encounterId);
                return {};
            });
            ...
            return Object.assign(Object.assign(Object.assign(Object.assign({}, fhirClientResource), yield subject()), yield encounter()), yield context());
        });
    }
    /**
