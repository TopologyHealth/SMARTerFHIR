...
export default class BaseClient {
    ...
    static constructEndpoints(tokenEP, r4EP, authorizeEP) {
        var _a, _b, _c;
        const authorizeEnv = (_a = process.env.NEXT_PUBLIC_AUTHORIZE_ENDPOINT) !== null && _a !== void 0 ? _a : process.env.REACT_APP_AUTHORIZE_ENDPOINT;
        const tokenEnv = (_b = process.env.NEXT_PUBLIC_TOKEN_ENDPOINT) !== null && _b !== void 0 ? _b : process.env.REACT_APP_TOKEN_ENDPOINT;
        const r4Env = (_c = process.env.NEXT_PUBLIC_R4_ENDPOINT) !== null && _c !== void 0 ? _c : process.env.REACT_APP_R4_ENDPOINT;
