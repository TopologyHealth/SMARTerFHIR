    ...
    executeWebLaunch(launchType, redirectPath, emrType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (emrType === undefined)
                emrType = getEMRType(new URL(iss));
            if (emrType === EMR.NONE)
...
function getEmrSpecificScopes(emrType, launchType) {
    var _a, _b;
    const scopesEnv = (_b = (_a = process.env.REACT_APP_SCOPES) !== null && _a !== void 0 ? _a : process.env.NEXT_PUBLIC_SCOPES) !== null && _b !== void 0 ? _b : process.env.SCOPES;
    if (scopesEnv) {
