...
export default class SmartLaunchHandler {
     ...
     */
    authorizeEMR(launchType = LAUNCH.EMR) {
        return __awaiter(this, void 0, void 0, function* () {
            if (launchType === LAUNCH.BACKEND) {
                throw new Error(`Direct Backend Authorization not supported yet.`);
            }
            else {
                return yield this.executeWebLaunch(launchType);
            }
        });
    }
    /**
    ...
    executeWebLaunch(launchType) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (emrType) {
                case EMR.EPIC:
                    yield this.epicLaunch(originString, iss, launchType);
                    break;
                case EMR.CERNER:
                    yield this.cernerLaunch(originString, iss, launchType);
                    break;
                case EMR.SMART:
                    yield this.smartHealthITLaunch(originString, iss, launchType);
                    break;
                default:
                    break;
            }
