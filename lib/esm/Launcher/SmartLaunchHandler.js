...
export default class SmartLaunchHandler {
     ...
     */
    authorizeEMR() {
        return __awaiter(this, arguments, void 0, function* (launchType = LAUNCH.EMR, redirectPath) {
            if (launchType === LAUNCH.BACKEND) {
...
function getEmrSpecificScopes(emrType, launchType) {
    var _a;
    const scopesEnv = (_a = process.env.REACT_APP_SCOPES) !== null && _a !== void 0 ? _a : process.env.NEXT_PUBLIC_SCOPES;
    if (scopesEnv) {
