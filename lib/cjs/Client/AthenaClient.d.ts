...
export default class AthenaClient extends BaseClient {
    EMR_TYPE: EMR;
    static readonly AUTHORIZE_ENDPOINT = "https://api.platform.athenahealth.com/oauth2/v1/authorize";
    static readonly TOKEN_ENDPOINT = "https://api.platform.athenahealth.com/oauth2/v1/token";
