...
var AthenaClient = /** @class */ (function (_super) {
     ...
     */
    function AthenaClient(fhirClientDefault) {
    ...
    AthenaClient.prototype.create = function (resource, patientId, encounterId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, _super.prototype.create.call(this, resource, patientId, encounterId, this.createHeaders(this.athenaCreateHeaders))];
            });
        });
    };
    AthenaClient.AUTHORIZE_ENDPOINT = "https://api.platform.athenahealth.com/oauth2/v1/authorize";
    AthenaClient.TOKEN_ENDPOINT = "https://api.platform.athenahealth.com/oauth2/v1/token";
    AthenaClient.R4_ENDPOINT = "https://api.platform.athenahealth.com/fhir/r4";
    return AthenaClient;
