...
var ECWClient = /** @class */ (function (_super) {
    ...
    ECWClient.getEndpoints = function () {
        return BaseClient_1.default.constructEndpoints(ECWClient.TOKEN_ENDPOINT, ECWClient.R4_ENDPOINT, ECWClient.AUTHORIZE_ENDPOINT);
    };
    ECWClient.prototype.getEndpoints = function () {
