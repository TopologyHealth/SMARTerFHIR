                    ...
                    case 3:
                        ...
                        switch (emrType) {
                            case SmartLaunchHandler_1.EMR.EPIC:
                                return [2 /*return*/, new EpicClient_1.default(defaultFhirClient)];
                            case SmartLaunchHandler_1.EMR.CERNER:
                                return [2 /*return*/, new CernerClient_1.default(defaultFhirClient)];
                            case SmartLaunchHandler_1.EMR.SMART:
                                return [2 /*return*/, new SmartHealthClient_1.default(defaultFhirClient)];
