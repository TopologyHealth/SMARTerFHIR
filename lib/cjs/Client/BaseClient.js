...
var BaseClient = /** @class */ (function () {
    ...
    BaseClient.prototype.hydrateResource = function (fhirClientResource, r4Resource, patientId, encounterId) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var subject, encounter, context, _d, _e, _f;
            var _this = this;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        _d = [__assign({}, fhirClientResource)];
                        return [4 /*yield*/, subject()];
                    case 1:
                        _e = [__assign.apply(void 0, _d.concat([(_a = _g.sent()) !== null && _a !== void 0 ? _a : {}]))];
                        return [4 /*yield*/, encounter()];
                    case 2:
                        _f = [__assign.apply(void 0, _e.concat([(_b = _g.sent()) !== null && _b !== void 0 ? _b : {}]))];
                        return [4 /*yield*/, context()];
                    case 3: return [2 /*return*/, __assign.apply(void 0, _f.concat([(_c = _g.sent()) !== null && _c !== void 0 ? _c : {}]))];
                }
            });
        });
    };
