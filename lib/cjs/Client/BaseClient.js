...
var BaseClient = /** @class */ (function () {
     ...
     */
    BaseClient.prototype.createReferenceToEncounter = function (encounterIdParam) {
        return __awaiter(this, void 0, void 0, function () {
            var encounterID, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    BaseClient.prototype.createEncounterReferenceArray = function (encounterIdParam) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.createReferenceToEncounter(encounterIdParam)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, this.createEncounterReference(encounterId)];
                                    case 1: return [2 /*return*/, _a.sent()];
                                    case 2: return [2 /*return*/, {}];
                                }
                            });
                    ...
                    case 3: return [2 /*return*/, __assign.apply(void 0, _c.concat([_d.sent()]))];
                }
            });
        });
    };
