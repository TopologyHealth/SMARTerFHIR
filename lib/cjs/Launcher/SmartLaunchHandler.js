...
function getEmrSpecificScopes(emrType, launchType) {
    var _a, _b;
    var scopesEnv = (_b = (_a = process.env.REACT_APP_SCOPES) !== null && _a !== void 0 ? _a : process.env.NEXT_PUBLIC_SCOPES) !== null && _b !== void 0 ? _b : process.env.SCOPES;
    if (scopesEnv) {
        ...
        var scopesEnvList = scopesEnv.split(',').map(String.prototype.trim);
