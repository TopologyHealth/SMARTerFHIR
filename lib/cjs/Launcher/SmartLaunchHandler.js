...
var SmartLaunchHandler = /** @class */ (function () {
    ...
    SmartLaunchHandler.prototype.launchEMR = function (emrType, redirect, iss, launchType, scopes) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                authorizeParams = __assign({ client_id: this.clientID, iss: iss, redirect_uri: redirect_uri, scope: scope, clientSecret: this.clientSecret }, emrSpecificAuthorizeParams);
                return [2 /*return*/, FHIR.oauth2.authorize(authorizeParams)];
            });
        });
    };
    /**
    ...
    SmartLaunchHandler.prototype.authorizeEMR = function () {
        return __awaiter(this, arguments, void 0, function (launchType, redirectPath) {
    ...
    SmartLaunchHandler.prototype.executeWebLaunch = function (launchType, redirectPath) {
        return __awaiter(this, void 0, void 0, function () {
            var queryString, origin, isAbsoluteUrl, redirect, urlParams, iss, emrType;
            var _a;
...
function getEmrSpecificScopes(emrType, launchType) {
    var _a;
    var scopesEnv = (_a = process.env.REACT_APP_SCOPES) !== null && _a !== void 0 ? _a : process.env.NEXT_PUBLIC_SCOPES;
    if (scopesEnv) {
        var hasCommaSeparators = scopesEnv.includes(',');
        if (!hasCommaSeparators)
            throw new Error('Scopes Env var is of invalid format. Scopes must be provided as a string of comma-separated values');
        var scopesEnvList = scopesEnv.split(',').map(function (item) { return item.trim(); });
    ...
    switch (emrType) {
        ...
        case EMR.ATHENAPRACTICE:
            return ["profile", launchType === ClientFactory_1.LAUNCH.STANDALONE ? "launch/patient" : "launch", Scopes_1.FhirScopePermissions.get(Scopes_1.Actor.USER, Scopes_1.Action.READ, ["Patient"])];
        case EMR.ATHENA:
