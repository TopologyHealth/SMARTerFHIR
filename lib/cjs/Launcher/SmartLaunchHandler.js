...
var AthenaClient_1 = __importDefault(require("../Client/AthenaClient"));
var EMR;
(function (EMR) {
    EMR["CERNER"] = "cerner";
    EMR["EPIC"] = "epic";
...
var SmartLaunchHandler = /** @class */ (function () {
     ...
     * @returns {Promise<string | void>} - A promise resolving to the authorization response or void.
     */
    SmartLaunchHandler.prototype.athenaLaunch = function (redirect, iss, launchType) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.launchEMR(redirect, iss, launchType, [])];
            });
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        switch (_b) {
                            ...
                            case EMR.ATHENA: return [3 /*break*/, 7];
                        }
                        return [3 /*break*/, 9];
                    ...
                    case 6:
                        _c.sent();
                        return [3 /*break*/, 10];
                    case 7: return [4 /*yield*/, this.athenaLaunch(redirect, iss, launchType)];
                    case 8:
                        _c.sent();
                        return [3 /*break*/, 10];
