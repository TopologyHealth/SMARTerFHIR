...
var SmartLaunchHandler = /** @class */ (function () {
    ...
    // emrSpecificScopes: string[]
        ...
        return __awaiter(this, void 0, void 0, function () {
            var defaultScopes, emrSpecificScopes, scope, pkceMode, redirect_uri;
            return __generator(this, function (_a) {
                ...
                emrSpecificScopes = getEmrSpecificScopes(emrType);
                scope = __spreadArray(__spreadArray([], defaultScopes, true), emrSpecificScopes, true).join(" ");
                pkceMode = getEMRSpecificPkceMode(emrType);
...
function getEmrSpecificScopes(emrType) {
    switch (emrType) {
        case EMR.CERNER:
            return Config_1.cerner.scopes.map(function (name) { return scopes_json_1.default[name]; });
        case EMR.EPIC:
        case EMR.SMART:
        case EMR.ECW:
        default:
...
function getEMRSpecificPkceMode(emrType) {
    switch (emrType) {
        case EMR.ECW:
            return 'unsafeV1';
        case EMR.CERNER:
