...
var SmartLaunchHandler = /** @class */ (function () {
     ...
     */
    function SmartLaunchHandler(clientID, clientSecret, scope) {
        /**
     ...
     */
    SmartLaunchHandler.prototype.launchEMR = function (emrType, redirect, iss, launchType) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                defaultScopes = ["openid", "fhirUser"];
                emrSpecificScopes = this.getEmrSpecificScopes(emrType, launchType);
                scope = __spreadArray(__spreadArray([], defaultScopes, true), emrSpecificScopes, true).reduce(function (acc, val) {
                    // Deduplicate scopes
                    if (!acc.includes(val))
                        acc.push(val);
                    return acc;
    ...
    SmartLaunchHandler.prototype.executeWebLaunch = function (launchType, redirectPath, emrType) {
        return __awaiter(this, void 0, void 0, function () {
            var queryString, origin, isAbsoluteUrl, redirect, urlParams, iss, inferredEmrType, isInvalidEmrType;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        inferredEmrType = (0, utils_1.getEMRType)(new URL(iss));
                        isInvalidEmrType = emrType === undefined && inferredEmrType === EMR.NONE;
                        if (isInvalidEmrType)
                            throw new Error("EMR type cannot be inferred from the ISS");
                        return [4 /*yield*/, this.launchEMR(emrType !== null && emrType !== void 0 ? emrType : inferredEmrType, redirect, iss, launchType)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
     ...
     */
    SmartLaunchHandler.prototype.getEmrSpecificScopes = function (emrType, launchType) {
...
function generatePreconfiguredScopes(launchType, emrType) {
    ...
    switch (emrType) {
        ...
        case EMR.MEDITECH:
            return ["launch/patient", Scopes_1.FhirScopePermissions.get(Scopes_1.Actor.PATIENT, Scopes_1.Action.READ, '*')];
        case EMR.EPIC:
        case EMR.SMART:
        default:
