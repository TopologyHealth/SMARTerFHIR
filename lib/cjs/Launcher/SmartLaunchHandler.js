...
exports.instanceOfEmr = exports.EMR = void 0;
...
function getEmrSpecificScopes(emrType, launchType) {
    ...
    switch (emrType) {
        ...
        case EMR.ECW:
            return [
                launchType === ClientFactory_1.LAUNCH.STANDALONE ? "launch/patient" : "launch",
                Scopes_1.FhirScopePermissions.get(Scopes_1.Actor.USER, Scopes_1.Action.READ, [
                    "Patient",
                    "Encounter",
                    "Practitioner",
                ]),
