...
function getEmrSpecificScopes(emrType, launchType) {
    ...
    switch (emrType) {
        ...
        case EMR.ATHENAPRACTICE:
            return ["profile", launchType === ClientFactory_1.LAUNCH.STANDALONE ? "launch/patient" : "launch"];
        case EMR.ATHENA:
            return ["profile", "offline_access", launchType === ClientFactory_1.LAUNCH.STANDALONE ? "launch/patient" : "launch"];
        case EMR.EPIC:
        case EMR.SMART:
        default:
