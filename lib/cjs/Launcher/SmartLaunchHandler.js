...
var SmartLaunchHandler = /** @class */ (function () {
    ...
    SmartLaunchHandler.prototype.launchEMR = function (emrType, redirect, iss, launchType, scopes) {
        return __awaiter(this, void 0, void 0, function () {
            var defaultScopes, emrSpecificScopes, scope, emrSpecificAuthorizeParams, redirect_uri, emrSpecificUrlsParams, authorizeParams, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        emrSpecificUrlsParams = getEMRSpecificUrlParams(emrType);
                        ...
                        return [4 /*yield*/, FHIR.oauth2.authorize(authorizeParams)];
                    case 1:
                        url = _a.sent();
                        if (!url)
...
function getEmrSpecificScopes(emrType, launchType) {
    ...
    switch (emrType) {
        ...
        case EMR.ATHENAPRACTICE:
            ...
            if (launchType === ClientFactory_1.LAUNCH.EMR)
