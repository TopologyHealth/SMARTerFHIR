...
export default class AthenaPracticeClient extends BaseClient {
  static readonly AUTHORIZE_ENDPOINT = "https://ap23sandbox.fhirapi.athenahealth.com/demoAPIServer/oauth2/authorize"
  static readonly TOKEN_ENDPOINT = "https://ap23sandbox.fhirapi.athenahealth.com/demoAPIServer/oauth2/token"
  static readonly R4_ENDPOINT = "https://ap23sandbox.fhirapi.athenahealth.com/demoAPIServer/fhir/r4"
